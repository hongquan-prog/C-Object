...
bool dual_circle_push_back(list_obj_t *list, list_node_t * node);
bool dual_circle_push_front(list_obj_t *list, list_node_t * node);
void dual_circle_pop_front(list_obj_t *list, list_node_t * node);
void dual_circle_pop_back(list_obj_t *list, list_node_t * node);
